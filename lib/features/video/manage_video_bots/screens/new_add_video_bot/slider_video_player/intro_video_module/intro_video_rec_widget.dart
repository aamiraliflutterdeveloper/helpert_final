...
//
// class IntroVideoRecWidget extends StatefulWidget {
//   final CameraController cameraController;
//   final GestureTapCallback? callBack;
//   IntroVideoRecWidget({Key? key, required this.cameraController, this.callBack})
//       : super(key: key);
//
//   @override
//   _IntroVideoRecWidgetState createState() => _IntroVideoRecWidgetState();
// }
//
// class _IntroVideoRecWidgetState extends State<IntroVideoRecWidget>
...
//                 MaterialPageRoute(
//                     builder: (context) =>
//                         RecordedVideoViewScreen(index: 1))).then((value) {
//               if (mounted) setState(() {});
//             });
//           }
//           _recordingTimer.cancel();
...
//                       padding: const EdgeInsets.symmetric(horizontal: 16.0),
//                       child: Text(
//                         "Hi, this is Sadik. I'll be sharing my career experience with 10000 startups on Expertrons to help millions of aspirants like you",
